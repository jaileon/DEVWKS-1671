...
while True:
    ...
    if userInput == '1':
        ...
        bannerJsonPayload = {
          ...
          "templateType": "banner","templateMinVersion": "15.0.0",
          "templateDefinition": {
          "login": {
            "vipObjectType": "object", "vipType": "constant", "vipValue": loginBanner, "vipVariableName": "banner_login"
            },
            "motd": {
              "vipObjectType": "object", "vipType": "constant","vipValue": motdBanner, "vipVariableName": "banner_motd"
              }
            },
          "transitionInProgress": True,
          "viewMode": "add",
          "deviceType": ["vedge-CSR-1000v"],
          "deviceModels": [{"name": "vedge-CSR-1000v","displayName": "CSR1000v","deviceType": "vedge","isCliSupported": False,"isCiscoDeviceModel": True}],
        ...
        configTemplateId = input('ENTER CONFIGURATION TEMPLATE ID: ')
        attachFeatureJson = {
        "deviceTemplateList": [{"templateId": configTemplateId, "device": [{
        "csv-status": "complete",
